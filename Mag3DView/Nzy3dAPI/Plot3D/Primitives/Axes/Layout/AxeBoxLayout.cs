...
namespace Mag3DView.Nzy3dAPI.Plot3D.Primitives.Axes.Layout
{
	public class AxeBoxLayout : IAxeLayout
	{
		...
		public ITickProvider XTickProvider
		{
		...
		public ITickProvider YTickProvider
		{
		...
		public ITickProvider ZTickProvider
		{
		...
		public ITickRenderer XTickRenderer
		{
			get { return _xTickRenderer; }
			set { _xTickRenderer = value; }
		}

		public ITickRenderer YTickRenderer
		{
			get { return _yTickRenderer; }
			set { _yTickRenderer = value; }
		}

		public ITickRenderer ZTickRenderer
		{
