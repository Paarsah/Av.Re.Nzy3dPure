...
namespace Mag3DView.Nzy3dAPI.Plot3D.Primitives
{
	public sealed class Polygon : AbstractWireframeable, ISingleColorable, IMultiColorable
	{
		...
		public override double GetDistance(Camera camera)
		{
			return Barycentre.Distance(camera.Eye);
		}

		public override double GetShortestDistance(Camera camera)
		{
		...
		public override double GetLongestDistance(Camera camera)
		{
			double max = 0;
			foreach (Point p in _points)
			{
