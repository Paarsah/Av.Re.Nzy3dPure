...
namespace Mag3DView.Nzy3dAPI.Plot3D.Builder.Delaunay.Jdt
{
	...
	public class Delaunay_Triangulation : ITriangulation
	{
        ...
        IEnumerator<global::Mag3DView.Nzy3dAPI.Plot3D.Builder.Delaunay.Jdt.Triangle_dt> ITriangulation.TrianglesIterator()
        {
            throw new NotImplementedException();
        }

        IEnumerator<global::Mag3DView.Nzy3dAPI.Plot3D.Builder.Delaunay.Jdt.Point_dt> ITriangulation.VerticesIterator()
        {
            throw new NotImplementedException();
        }
    }
