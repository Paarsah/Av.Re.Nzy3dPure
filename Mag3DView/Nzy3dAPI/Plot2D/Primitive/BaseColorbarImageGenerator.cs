...
using Mag3DView.Nzy3dAPI.Plot3D.Primitives.Axes.Layout.Providers;
using Mag3DView.Nzy3dAPI.Plot3D.Primitives.Axes.Layout.Renderers;

namespace Mag3DView.Nzy3dAPI.Plot2D.Primitive
{
	public abstract class BaseColorbarImageGenerator
	{
		...
		public BaseColorbarImageGenerator(IColorMap map, float min, float max, ITickProvider provider, ITickRenderer renderer)
		{
		...
		public BaseColorbarImageGenerator(ColorMapper mapper, ITickProvider provider, ITickRenderer renderer)
